...
// 참고(2026-08-06): 인천 행정개편 반영으로 지역 수가 114 → 115가 됐다(신설 4 − 폐지 3). 아래와
//   위쪽 주석의 114·2,964는 전부 2026-07-28 시점의 실측 기록이라 그대로 둔다 — 순회 주기는
//   115÷3 ≈ 38.3으로 결론이 바뀌지 않는다. totalRegions는 런타임 계산이라 코드 수정도 불필요하다.
