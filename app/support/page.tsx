  ...
  },
  {
    ...
    a: (
      <>
        ...
        건물유형 버튼에도 &quot;(준비 중)&quot;으로 표시되어 있으며 아직 선택할
  ...
  },
  {
    ...
    a: (
      <>
        ...
        신축과 함께 4가지 선호도 중 하나로 반영됩니다. 고도 자료를 충분히
        가져오지 못한 단지는 점수가 빠지는 것이 아니라 미리 정해 둔 중간
        정도의 값이 들어가고, 단지 좌표 자체를 확인하지 못한 단지만
        &apos;측정불가&apos;로 표시됩니다. &apos;측정불가&apos;인 단지도 정렬에서 빠지지 않고,
        이 항목을 최저점으로 두고 함께 정렬됩니다.
      </>
    ),
  },
  {
