  ...
  },
  {
    ...
    a: (
      <>
        ...
        모든 정보는 참고용입니다. AI 맞춤 추천 역시 입력하신 선호도(예산·
        역세권·신축 등)에 따라 후보 단지를 점수화해 정렬한 결과일 뿐, 수익성이나
  ...
  },
  {
    ...
    a: (
      <>
        ...
        차이가 작을수록 높은 점수를 주는 방식으로 계산합니다. 예산·역세권·
        신축 여부와 함께 4가지 선호도 중 하나로 반영되며, 좌표나 고도 정보를
