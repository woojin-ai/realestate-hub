...
const OPTIONS: { type: BuildingType; label: string; comingSoon?: boolean }[] = [
  { type: "아파트", label: "🏢 아파트" },
  { type: "빌라", label: "🏘️ 빌라", comingSoon: true },
  { type: "단독", label: "🏠 단독", comingSoon: true },
];
    ...
    <div className="flex gap-2 overflow-x-auto mb-3">
      {OPTIONS.map((opt) => (
        <button
          ...
          className="shrink-0 rounded-full border-2 px-4 py-2 text-sm transition-colors relative
