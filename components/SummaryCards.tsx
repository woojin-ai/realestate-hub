      ...
      {pct !== null && diff !== null && (
        <div className={`text-xs mt-1 ${lowSample ? "text-gray-600" : colorClass}`}>
          {/* 부호는 +/- 대칭이어야 한다. 예전에는 음수 분기가 ""여서 -5,000만원이 부호 없는
              ...
              ⚠️ 이 사례는 2026-08-06부로 **재현 불가**다 — 28260이 행정개편으로 REGION_CODES에서
              제거돼 화면에서 도달할 수 없다(그 전세 2건은 승계 구 28290에 동일 행으로 존재한다).
              버그 자체와 아래 방어 로직은 그대로 유효하니 사례가 낡았다고 걷어내지 말 것.
